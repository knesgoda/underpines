...
const biomes = {
  ...
  'mediterranean': {
    ...
    seasonalOverrides: {
      litha:   { '--seasonal-summer-detail-opacity': '0.8', '--biome-accent': '#d4a030' },
      mabon:   { '--biome-canopy': '#3a5a2a', '--seasonal-summer-detail-opacity': '0' },
      yule:    { '--biome-canopy': '#2a4a2a', '--seasonal-summer-detail-opacity': '0' },
    },
    hasWater: true,
  ...
  'mountain-west': {
    ...
    seasonalOverrides: {
      ostara:  { '--seasonal-spring-detail-opacity': '0.7' },
      mabon:   { '--biome-canopy': '#d4a020', '--biome-accent': '#daa520' },
